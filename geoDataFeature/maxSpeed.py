...
# Messen der Zeit für das Laden der CSV-Datei
...
# Messen der Zeit für das Laden der GeoJSON-Datei
start_time = time.time()
...
# Messen der Zeit für die Umwandlung der MultiLineString-Objekte
start_time = time.time()
...
# Erstellen eines räumlichen Indexes für die LineStrings
...
# Messen der Zeit für die Überprüfung der Koordinaten
start_time = time.time()
result = []
