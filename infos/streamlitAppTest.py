...
#  Vorhersage, ob es sich zB um einen Unfall mit einbiegendem KFZ handelt
# predicted_category = predictions[0][0]
# predicted_uart = predictions[0][1]
# predicted_utyp1 = predictions[0][2]
#
# st.subheader("Vorhersage")
# st.write(f"Unfallkategorie: {predicted_category}")
#
# st.subheader("Wahrscheinlichkeit")
# st.bar_chart(prediction_proba[0])
#
...
# st.write(f"Vorhergesagter Unfallart: {predicted_uart}")
# st.write(f"Vorhergesagter Unfalltyp: {predicted_utyp1}")